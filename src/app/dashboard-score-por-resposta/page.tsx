...
type AnswerData = { answer_text: string; lead_count: number; percentage: number; };
type QuestionAnalysisData = { question_id: string; question_text: string; answers: AnswerData[]; };
                ...
                {questionData.answers.map((answer, index) => (
                    <li key={index}>
                        <div className="flex justify-between items-center mb-1 text-sm">
                            ...
                            <span className="font-medium text-slate-700 flex-shrink-0">{answer.lead_count.toLocaleString('pt-BR')} ({answer.percentage.toFixed(1)}%)</span>
                        </div>
