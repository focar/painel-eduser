// CAMINHO: src/app/dashboard-traqueamento/detalhe-organico/score/page.tsx
'use client';
...
// ✅ CONFIG ATUALIZADO com as faixas de score corretas
...
// --- Componente do Gráfico de Rosca ---
...
function ScorePageContent() {
  ...
  const fetchData = useCallback(async (id: string) => {
    setIsLoading(true);
    try {
      const { data: result, error } = await supabase.rpc('get_organic_score_breakdown_by_medium', { p_launch_id: id });
  ...
  return (
    <div className="bg-[#1e2b41] min-h-screen text-white p-4 sm:p-6 lg:p-8">
      <header className="flex items-center gap-6 mb-8">
        ...
        <div>
          <p className="text-sm text-slate-400 uppercase tracking-wider">Análise de Score - Tráfego Orgânico</p>
